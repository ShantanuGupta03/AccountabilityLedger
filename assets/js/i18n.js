...
(() => {
  ...
  const EN = {
    ...
    /* Cite and export. Printed as text in the HTML; these are the button labels. */
    card_cite: "Cite or export →",
    cite_heading: "Cite or export this case",
    cite_copy: "Copy the citation",
    cite_copy_url: "Copy the link only",
    cite_json: "JSON for this case",
    cite_all_data: "The whole ledger as CSV",
    cite_copied: "Copied",
    cite_select: "Selected, press Ctrl+C",
    cite_note: "Quote the case id rather than the number on the card. The id never changes; the number shifts whenever an older case is added ahead of this one.",
    ...
    field_timeline: "How it unfolded",
    timeline_legend: "Dates are as the record states them, which is sometimes a month or a year rather than a day. Entries marked in red are the ones where nothing happened next.",
    ...
    /* RTI response library. Read from JavaScript, so English lives here too. */
    rti_subnav_generate: "Generate an application",
    rti_subnav_responses: "Responses received",
    rtir_on_case_heading: "Asked officially. Here is what came back",
    rtir_on_case_note: "Responses to Right to Information applications filed by readers of this ledger. A reply on a public authority's letterhead is a primary record, and a refusal naming its own clause is one too. Each was checked by an editor before it appeared here.",
    rtir_on_case_add: "Filed one on this case? Add what you got",
    // The first-visit public-interest notice. Built at runtime, so both languages
    // are authored here.
    pg_notice: "Published in the public interest, about the public conduct of public office. Allegations are labelled as allegations, every claim is sourced, and anyone named has a standing right of reply.",
    pg_notice_link: "Why this exists \u2192",
    pg_notice_dismiss: "Understood",
    rtir_loading: "Loading the library\u2026",
    rtir_empty: "No responses on file yet. If you have filed one of these applications and heard back, you would be the first — and the first is worth more than the hundredth.",
    rtir_count: "{n} response(s) published against cases on this ledger.",
    rtir_asked: "Asked",
    rtir_replied: "Replied",
    rtir_read_reply: "Read the reply as received",
    rtir_see_document: "See the document",
    rtir_badge_answered: "Answered",
    rtir_badge_partial: "Partly answered",
    rtir_badge_refused: "Refused",
    rtir_badge_no_reply: "No reply at all",
    rtir_case_matches: "{n} matching. Pick the case you asked about.",
    rtir_case_none: "Nothing matches that. Try a minister's name, a year, or a word from the title.",
    rtir_cases_failed: "The case list could not be loaded. Reload the page.",
    rtir_pick_case: "Pick the case you asked about first.",
    rtir_need_human: "Complete the human-verification check above, then send.",
    rtir_sending: "Sending\u2026",
    rtir_sent: "Thank you. An editor will check it before it appears against the case.",
    rtir_failed: "Unable to send that response.",
    rtir_expired: "Human verification expired. Please complete it again.",
    rtir_loading_human: "Loading human verification\u2026",
    rtir_complete_human: "Complete the verification check above before sending.",
    rtir_local_bypass: "Local development: human verification is bypassed on this host.",
    rtir_degraded: "Human verification could not be shown here, so it has been skipped. You can still send this: it will be queued as unverified and read by an editor by hand.",
    ...
    rti_copied: 'Copied. Paste it into <a href="https://rtionline.gov.in" target="_blank" rel="noopener">rtionline.gov.in</a> or into a letter.',
  ...
  const HI = {
    ...
    card_cite: "उद्धृत या निर्यात करें →",
    cite_heading: "इस मामले को उद्धृत या निर्यात करें",
    cite_copy: "उद्धरण कॉपी करें",
    cite_copy_url: "केवल लिंक कॉपी करें",
    cite_json: "इस मामले का JSON",
    cite_all_data: "पूरा लेजर CSV में",
    cite_copied: "कॉपी हो गया",
    cite_select: "चुन लिया गया, Ctrl+C दबाइए",
    cite_note: "कार्ड पर दिए नंबर के बजाय मामले की id उद्धृत कीजिए। id कभी नहीं बदलती; नंबर तब बदल जाता है जब कोई पुराना मामला उससे पहले जोड़ा जाता है।",
    ...
    field_timeline: "यह कैसे आगे बढ़ा",
    timeline_legend: "तारीख़ें वैसी ही दी गई हैं जैसी रिकॉर्ड में हैं — कभी पूरा दिन, कभी केवल महीना या वर्ष। लाल निशान वाली प्रविष्टियाँ वे हैं जिनके बाद कुछ नहीं हुआ।",
    field_sources: "स्रोत",
    ...
    /* RTI response library */
    rti_subnav_generate: "आवेदन तैयार करें",
    rti_subnav_responses: "मिले जवाब",
    rtir_eyebrow: "पत्र का दूसरा आधा हिस्सा",
    rtir_title_main: "उन्होंने क्या",
    rtir_title_thin: "जवाब दिया।",
    rtir_standfirst: "आवेदन बनाना आसान हिस्सा है। रिकॉर्ड यह आधा हिस्सा बदलता है। मंत्रालय के लेटरहेड पर आया जवाब एक प्राथमिक दस्तावेज़ है, और जब तक कोई उसे यहाँ न रखे, वह इंटरनेट पर कहीं नहीं होता। इनकार भी गिनती में है: \"धारा 8(1)(क) के अंतर्गत अस्वीकृत\" कोई अंत नहीं, बल्कि सरकार का लिखकर बताना है कि उसने कौन सा दरवाज़ा बंद किया। अगर आपने इनमें से कोई आवेदन लगाया था, जो मिला वह यहाँ लाइए।",
    rtir_stat_total: "फ़ाइल पर आए जवाब",
    rtir_stat_refused: "इनकार, धारा का नाम लेकर",
    rtir_stat_silent: "जिनका कोई जवाब ही नहीं आया",
    rtir_form_title: "आपको मिला जवाब जोड़िए",
    rtir_form_lead: "आवेदन लगाया और जवाब मिला? इस लेजर को दी जा सकने वाली सबसे उपयोगी चीज़ यही है। इसके चौरासी में से छियासठ मामले केवल रिपोर्टिंग पर टिके हैं, और यही वह कमज़ोर पक्ष है जिसका सहारा लेकर सरकार किसी मामले को \"मीडिया की कहानी\" कह देती है। एक सरकारी जवाब यह बदल देता है।",
    rtir_field_case: "आपने किस मामले के बारे में पूछा था?",
    rtir_case_search: "शीर्षक, मंत्री या वर्ष से खोजें",
    rtir_field_case_select: "मिलते-जुलते मामले",
    rtir_field_authority: "आपने किस लोक प्राधिकरण से पूछा?",
    rtir_field_applied: "आवेदन की तिथि",
    rtir_field_replied: "जवाब की तिथि",
    rtir_field_outcome: "क्या जवाब आया?",
    rtir_outcome_pick: "एक चुनिए",
    rtir_outcome_answered: "उन्होंने जवाब दिया",
    rtir_outcome_partial: "उन्होंने आंशिक जवाब दिया",
    rtir_outcome_refused: "उन्होंने धारा का हवाला देकर इनकार किया",
    rtir_outcome_none: "कुछ भी जवाब नहीं आया",
    rtir_field_section: "उन्होंने किस धारा के अंतर्गत इनकार किया?",
    rtir_field_summary: "जवाब में क्या कहा गया, अपने शब्दों में?",
    rtir_field_text: "जवाब का पूरा पाठ, टाइप किया हुआ",
    rtir_field_text_hint: "(वैकल्पिक, और किसी भी सारांश से अधिक मूल्यवान)",
    rtir_field_doc: "स्कैन या फ़ोटो का लिंक",
    rtir_field_doc_hint: "(वैकल्पिक; निजी विवरण हटाकर, और लॉगिन के बिना खुलने वाला)",
    rtir_field_email: "आगे संपर्क के लिए ईमेल",
    rtir_field_email_hint: "(वैकल्पिक; कभी प्रकाशित नहीं)",
    rtir_field_redaction: "जो कुछ मैं ऊपर लिंक या टाइप कर रहा/रही हूँ, उसमें से मैंने अपना नाम, पता और फ़ोन नंबर हटा दिया है।",
    rtir_submit: "संपादक को भेजें",
    rtir_on_case_heading: "आधिकारिक रूप से पूछा गया। जवाब में यह आया",
    rtir_on_case_note: "इस लेजर के पाठकों द्वारा लगाए गए सूचना-अधिकार आवेदनों के जवाब। किसी लोक प्राधिकरण के लेटरहेड पर आया जवाब एक प्राथमिक अभिलेख है, और अपनी धारा का नाम लेने वाला इनकार भी। यहाँ दिखने से पहले हर जवाब संपादक द्वारा जाँचा गया है।",
    rtir_on_case_add: "इस मामले पर आवेदन लगाया था? जो मिला वह जोड़िए",
    pg_notice: "लोकहित में प्रकाशित, लोक पद के सार्वजनिक आचरण के बारे में। आरोपों को आरोप के रूप में चिह्नित किया गया है, हर दावा स्रोत-सहित है, और यहाँ नामित किसी भी व्यक्ति को उत्तर देने का स्थायी अधिकार है।",
    pg_notice_link: "यह क्यों मौजूद है \u2192",
    pg_notice_dismiss: "समझ गया",
    rtir_loading: "लाइब्रेरी लोड हो रही है\u2026",
    rtir_empty: "अभी कोई जवाब फ़ाइल पर नहीं है। अगर आपने इनमें से कोई आवेदन लगाया है और जवाब मिला है, तो आप पहले होंगे — और पहला जवाब सौवें से ज़्यादा कीमती है।",
    rtir_count: "इस लेजर के मामलों के विरुद्ध {n} जवाब प्रकाशित।",
    rtir_asked: "पूछा",
    rtir_replied: "जवाब",
    rtir_read_reply: "जैसा मिला, वैसा जवाब पढ़ें",
    rtir_see_document: "दस्तावेज़ देखें",
    rtir_badge_answered: "जवाब दिया",
    rtir_badge_partial: "आंशिक जवाब",
    rtir_badge_refused: "इनकार",
    rtir_badge_no_reply: "कोई जवाब नहीं",
    rtir_case_matches: "{n} मामले मिले। जिसके बारे में पूछा था वह चुनिए।",
    rtir_case_none: "इससे कुछ नहीं मिला। किसी मंत्री का नाम, कोई वर्ष, या शीर्षक का एक शब्द आज़माइए।",
    rtir_cases_failed: "मामलों की सूची लोड नहीं हो सकी। पृष्ठ फिर से लोड कीजिए।",
    rtir_pick_case: "पहले वह मामला चुनिए जिसके बारे में आपने पूछा था।",
    rtir_need_human: "ऊपर की मानव-सत्यापन जाँच पूरी कीजिए, फिर भेजिए।",
    rtir_sending: "भेजा जा रहा है\u2026",
    rtir_sent: "धन्यवाद। मामले के साथ दिखाने से पहले संपादक इसे जाँचेंगे।",
    rtir_failed: "यह जवाब भेजा नहीं जा सका।",
    rtir_expired: "मानव सत्यापन समाप्त हो गया। कृपया इसे फिर पूरा कीजिए।",
    rtir_loading_human: "मानव सत्यापन लोड हो रहा है\u2026",
    rtir_complete_human: "भेजने से पहले ऊपर की सत्यापन जाँच पूरी कीजिए।",
    rtir_local_bypass: "स्थानीय विकास: इस होस्ट पर मानव सत्यापन छोड़ा जा रहा है।",
    rtir_degraded: "यहाँ मानव सत्यापन दिखाया नहीं जा सका, इसलिए उसे छोड़ दिया गया है। आप फिर भी भेज सकते हैं: यह असत्यापित के रूप में कतार में जाएगा और संपादक इसे हाथ से पढ़ेंगे।",
    ...
    rti_copied: 'कॉपी हो गया। इसे <a href="https://rtionline.gov.in" target="_blank" rel="noopener">rtionline.gov.in</a> पर या पत्र में चिपका दीजिए।',
    ...
    rti_help_file_union: 'केंद्रीय मंत्रालय और उनके विभाग <a href="https://rtionline.gov.in" target="_blank" rel="noopener">rtionline.gov.in</a> पर ऑनलाइन आवेदन लेते हैं, जो सबसे तेज़ रास्ता है और उसी दिन पंजीकरण संख्या दे देता है। डाक भी चलती है: लिफ़ाफ़ा पत्र में दिए पते पर केंद्रीय लोक सूचना अधिकारी के नाम, पंजीकृत या स्पीड पोस्ट से भेजिए, और रसीद सँभालकर रखिए।',
    ...
    /* /about/ — publishing principles. English lives in the HTML. */
    about_flag_tag: "प्रकाशन सिद्धांत",
    about_eyebrow: "उद्देश्य, पद्धति और सीमाएँ",
    about_title_main: "यह क्यों मौजूद है।",
    about_title_thin: "और यह किन नियमों का पालन करता है।",
    about_standfirst: "हर जवाबदेही परियोजना को एक ही जगह यह बताने को तैयार रहना चाहिए कि वह किसलिए है और क्या नहीं करेगी। यह वही पन्ना है। इस लेजर के बारे में वकील को चिट्ठी लिखने से पहले भी यही पढ़ना चाहिए, क्योंकि ऐसी चिट्ठी जो पूछेगी उसका ज़्यादातर जवाब यहाँ पहले से सार्वजनिक है — जानबूझकर।",
    about_purpose_h: "यह क्यों प्रकाशित है",
    about_purpose_1: "यह लेजर लोकहित में प्रकाशित है, ताकि कोई भी नागरिक देख सके कि इस सदी में भारत में लोक पद का उपयोग कैसे हुआ, उसकी कीमत पैसे और जीवन में क्या रही, और क्या कभी किसी को जवाब देना पड़ा। यही पूरा उद्देश्य है। यहाँ कुछ भी मनोरंजन के लिए, किसी दल के लिए, या पैसे के लिए प्रकाशित नहीं है।",
    about_purpose_2: "लोक शक्ति का उपयोग कैसे होता है, यह लोकहित का विषय है, क्योंकि वह शक्ति जनता ने दी थी और जनता ने ही उसका खर्च उठाया। अपने पैसे, अपनी हवा, अपने रेल पुल या अपने परीक्षा-पत्र के बारे में पूछने वाला नागरिक कोई परेशानी नहीं है जिसे संभालना हो। लोकतंत्र में वही सवाल असली काम है। जो सरकार अपने रिकॉर्ड पर भरोसा रखती है, उसे ऐसे दस्तावेज़ से डरने की कोई वजह नहीं जो उसकी ही ऑडिट रिपोर्टें उसे लौटाकर दिखाता है।",
    about_scope_h: "केवल सार्वजनिक आचरण",
    about_scope_1: "यह लेजर <strong>लोक पद धारण करने वालों के सार्वजनिक आचरण</strong> को दर्ज करता है, उस पद के निर्वहन में। यह किसी के निजी जीवन, परिवार, स्वास्थ्य, आस्था, पद से बाहर की आर्थिक स्थिति या व्यक्तिगत संबंधों के बारे में कुछ दर्ज नहीं करता, और न करेगा। इस तरह की प्रविष्टियाँ समीक्षा के बजाय हटा दी जाती हैं।",
    about_scope_2: "किसी विफलता के समय कौन विभाग संभाल रहा था, यह बताना अभिलेख का विषय है। यह अपने आप में व्यक्तिगत गलती का आरोप नहीं है, और यह साइट हर उस पन्ने पर यही कहती है जहाँ यह दिखता है। मंत्री डैशबोर्ड <em>किसी विभाग के अंतर्गत दर्ज मामलों में</em> लागत और मृत्यु का योग देता है, और उन आँकड़ों को कभी किसी व्यक्ति के निजी कृत्य के रूप में नहीं जोड़ता।",
    about_notclaim_h: "यह क्या दावा नहीं करता",
    about_notclaim_1: "<strong>यह किसी को अपराधी नहीं कहता।</strong> जहाँ किसी अदालत ने दोष सिद्ध नहीं किया, वहाँ कोई दोष नहीं जताया गया है। जहाँ अदालत ने किसी को बरी किया, यह लेजर आरोप के साथ ही वह बात भी कहता है।",
    about_notclaim_2: "<strong>यह आरोप को तथ्य बनाकर नहीं रखता।</strong> फ़ैसले, ऑडिट, सरकारी स्वीकृतियाँ और प्रमाणित मृत्यु-संख्याएँ तथ्य के रूप में दर्ज हैं। विवादित बातें एक चिह्नित खाने में रहती हैं, उस रिपोर्टिंग, विपक्ष या अदालती प्रक्रिया के हवाले से जिसने उन्हें उठाया।",
    about_notclaim_3: "<strong>यह अनुमानों को हिसाब नहीं बताता।</strong> हर अनुमानित आँकड़ा चिह्नित है, ज़्यादातर विवादित दायरे हैं, और शीर्ष योग एक पैमाना है, बहीखाता नहीं। यह दावा नहीं है कि हर रुपया चोरी हुआ।",
    about_notclaim_4: "<strong>यह पूर्ण होने का दावा नहीं करता।</strong> चौरासी मामले एक सूची हैं, जनगणना नहीं। जिन मामलों का स्रोत नहीं दिया जा सकता, उन्हें बिल्ड रोक देता है और वे कभी प्रकाशित नहीं होते, चाहे वे कितने ही प्रसिद्ध हों।",
    about_notclaim_5: "<strong>यह किसी दल का नहीं है।</strong> दायरा 2000 से चलता है और उस अवधि की हर सरकार को शामिल करता है, केंद्र और राज्य दोनों, और हर मामले में एक ही कसौटी लगती है: क्या किसी को जवाब देना पड़ा?",
    about_sources_h: "दावों के स्रोत कैसे दिए जाते हैं",
    about_sources_intro: "हर प्रकाशित मामले के साथ कम से कम एक लिंक है जिसे पाठक खोलकर जाँच सकता है। यह अच्छे इरादों से नहीं, बिल्ड द्वारा लागू होता है। हर स्रोत को श्रेणी दी गई है, ताकि पाठक किसी की बात मानने के बजाय स्वयं तोल सके:",
    about_tier_1: "<span class=\"tier-badge tier-1\">T1</span> <strong>प्राथमिक अभिलेख।</strong> अदालती फ़ैसले, कैग ऑडिट, राजपत्र, कानून, सरकारी या नियामक प्रकाशन, संसदीय अभिलेख, आधिकारिक आँकड़े, समकक्ष-समीक्षित शोध।",
    about_tier_2: "<span class=\"tier-badge tier-2\">T2</span> <strong>स्वतंत्र रिपोर्टिंग और प्रमाणित शोध।</strong> स्थापित समाचार संस्थान, और वे अधिकार या शोध संस्थाएँ जो अपनी पद्धति और अपने साक्ष्य प्रकाशित करती हैं।",
    about_tier_3: "<span class=\"tier-badge tier-3\">T3</span> <strong>पक्षपाती, पैरवी-आधारित, संकलित या उपयोगकर्ता-संपादित।</strong> संकेत के तौर पर उपयोगी, सबूत के तौर पर कभी नहीं, और किसी मामले पर अकेला स्रोत कभी नहीं।",
    about_sources_gap: "साक्ष्य की ईमानदार स्थिति, आज: इस लेजर के 194 स्रोतों में से 23 प्राथमिक अभिलेख हैं। चौरासी में से छियासठ मामले केवल रिपोर्टिंग पर टिके हैं। यह इस परियोजना का सबसे कमज़ोर पहलू है और इसे छिपाने के बजाय यहाँ छापा गया है, क्योंकि जो लेजर अपने ही साक्ष्य को बढ़ाकर बताता है उसे किसी और से सटीकता माँगने का हक़ नहीं। इस खाई को भरना ही <a href=\"../rti/\">सूचना-अधिकार डेस्क</a> का काम है।",
    about_reply_h: "उत्तर का अधिकार, संशोधन और हटाना",
    about_reply_1: "इस लेजर पर नामित कोई भी व्यक्ति, या उनकी ओर से कोई, उत्तर देने का स्थायी अधिकार रखता है। रिकॉर्ड पर दिया गया और हस्ताक्षरित उत्तर उस मामले के साथ, पूरा, बिना भाषा बदले प्रकाशित किया जाएगा। यह पेशकश समाप्त नहीं होती और इसके लिए वकील की ज़रूरत नहीं।",
    about_reply_2: "तथ्यात्मक संशोधन किए जाते हैं। अगर कोई स्रोत ग़लत है, ग़लत पढ़ा गया है, बाद के फ़ैसले से बदल गया है, या उस पर खड़ी बात का समर्थन नहीं करता, तो मामला सुधारा या हटाया जाता है और वह बदलाव दर्ज होता है। अभिलेख दिखाइए, और यह किसी नोटिस से जल्दी ठीक होगा।",
    about_reply_cta: "संशोधन और उत्तर का अधिकार",
    about_data_cta: "पूरा लेजर डाउनलोड कीजिए",
    about_community_h: "यह किसका है",
    about_community_1: "जिसने बनाया, उसका नहीं। जो लेजर एक व्यक्ति के ध्यान पर निर्भर हो, उसमें विफलता का एक ही बिंदु होता है, और जो संस्था उसे मिटाना चाहे उसे बस इंतज़ार करना होगा। इसलिए अभिलेख खुला है: हर मामला CSV या JSON में डाउनलोड हो सकता है, हर मामले का एक स्थायी उद्धरण-योग्य पन्ना है, और कोई भी स्रोत और तारीख़ों के साथ <a href=\"../submit/\">मामला भेज सकता है</a>।",
    about_community_2: "कुछ भी अपने आप प्रकाशित नहीं होता। भेजी गई प्रविष्टि समीक्षा कतार में जाती है और दिखने से पहले इन नियमों पर जाँची जाती है — स्रोत खोले जाते हैं, श्रेणी दी जाती है, तथ्य को आरोप से अलग किया जाता है। इरादा यह है कि वह समीक्षा एक संपादक के बजाय योगदानकर्ताओं का समूह करे, और जो मानक लगे वही हो जो इस पन्ने पर लिखा है, जहाँ कोई भी उसे नतीजे के सामने रखकर परख सके।",
  };
